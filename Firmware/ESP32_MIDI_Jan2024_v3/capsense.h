...
const int touchPins[11] = {8, 9, 10, 5, 4, 3, 2, 1, 7, 6};
...
CapSense cap[] = {
    ...
    CapSense(touchPins[8], 9, UPPER_THRESHOLD, LOWER_THRESHOLD),
    CapSense(touchPins[9], 10, UPPER_THRESHOLD, LOWER_THRESHOLD)
};
